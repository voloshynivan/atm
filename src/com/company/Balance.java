...
public class Balance {
    ...
    public void getCards(String currency, int amount){
        ...
        //if conditions above did not met - calculate the minimum amount of notes
            ...
            ArrayList<Integer> moneyOnTheTable = putMoneyOnTheTable(getCurrentBalance().get(currency));
            int inf = 1000000000;
    ...
    private ArrayList<Integer> putMoneyOnTheTable(HashMap<Integer, Integer> valueNumber){
